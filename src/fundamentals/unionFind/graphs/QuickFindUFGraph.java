...
import fundamentals.unionFind.quickFind.QuickFindUF;
import libs.StdDraw;
import libs.StdIn;
...
/**
 * Graph for quick find union-find
 */
public class QuickFindUFGraph {
    public static void main(String[] args) {
        ...
        QuickFindUF qf = new QuickFindUF(N);       // Initialize N components
